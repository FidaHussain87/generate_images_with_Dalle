...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      setLoading(true)
      try {
        const response = await fetch('https://generate-images-with-dalle.vercel.app/api/v1/post', {
          method: 'POST',
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch('https://generate-images-with-dalle.vercel.app/api/v1/dalle', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    <section className="max-w-7xl mx-auto">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
       ...
       bg-gray-50 border
        ...
        text-sm rouded-lg focus:ring-blue-500
